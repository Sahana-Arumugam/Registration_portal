...
export const getAllCountries = (): Country[] => {
  ...
  return Object.keys(dialCodes).map(code => ({
    code,
...
/**
 * Detects user country based on locale. 
 * Updated to not auto-select a country.
 */
